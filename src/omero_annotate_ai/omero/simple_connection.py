...
class SimpleOMEROConnection:
    ...
    def save_password(self, host: str, username: str, password: str, expire_hours: Optional[int] = None) -> bool:
        ...
        try:
            ...
            if expire_hours:
                print(f"🔐 Password saved to keychain (expires in {expire_hours} hours)")
            else:
    ...
    def load_config_files(self) -> Dict[str, Any]:
        ...
        if not config:
            ...
            if connections:
                ...
                if "display_name" not in recent_conn:
                    recent_conn["display_name"] = f"{recent_conn['username']}@{recent_conn['host']}"
                ...
                print(f"📄 Loaded configuration from connection history: {recent_conn['display_name']}")
        ...
        if not config and OMERO_AVAILABLE:
            try:
                ...
                original_env = {}
                env_keys = ["OMERO_USER", "OMERO_PASSWORD", "OMERO_HOST", "OMERO_GROUP", "OMERO_PORT"]
                for key in env_keys:
    ...
    def test_connection(self, host: str, username: str, password: str, 
                       group: Optional[str] = None, secure: bool = True) -> Tuple[bool, str]:
    ...
    def save_connection_details(self, host: str, username: str, group: Optional[str] = None) -> bool:
        ...
        try:
            ...
            if existing_index is not None:
                ...
                connection_entry["created_at"] = connections[existing_index]["created_at"]
